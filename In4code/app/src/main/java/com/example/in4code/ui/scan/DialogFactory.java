...
import com.example.in4code.utils.ColorUtils;
...
public class DialogFactory {
    ...
    public static SweetAlertDialog getDialogProgress(Context context, String message) {
        ...
        progressDialog.getProgressHelper().setBarColor(ColorUtils.getColorFromResource(context, R.color.jade_theme_color));
