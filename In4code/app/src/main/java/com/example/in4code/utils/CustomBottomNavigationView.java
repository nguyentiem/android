package com.example.in4code.utils;
...
public class CustomBottomNavigationView extends BottomNavigationView {
    ...
    private final int CURVE_CIRCLE_RADIUS = getHeight() / 2;
    ...
    private void init() {
        ...
        mPaint.setColor(ColorUtils.getColorFromResource(getContext(), R.color.navigation_bar_shadow_color));
        mPaint.setShadowLayer(8, 0, 0, ColorUtils.getColorFromResource(getContext(), R.color.navigation_bar_shadow_color));
    }
