...
import com.pdfreader.scanner.pdfviewer.databinding.BrowserActivityBinding;
...
public class BrowserActivity extends BaseBindingActivity<BrowserActivityBinding, BrowserViewModel> implements BrowserNavigator {
...
//        browserActivityBinding = getViewDataBinding();
//
//        setForClick();
//        initView();
//        setForLiveData();
//        reloadData(true);
    ...
    public void reloadData(boolean isForceReload) {
        if (this != null && this.notHaveStoragePermission()) {
            browserActivityBinding.pullToRefresh.setRefreshing(false);
        ...
        browserActivityBinding.fileDir.setText("Dir: " + mCurrentFolder.getFilePath());
...
//            if (browserActivityBinding.dataListArea.getLayoutManager() != null) {
//                oldPosition = browserActivityBinding.dataListArea.getLayoutManager().onSaveInstanceState();
//            }
//            mFileListAdapter.setData(mListFile);
//            if (oldPosition != null) {
//                browserActivityBinding.dataListArea.getLayoutManager().onRestoreInstanceState(oldPosition);
//            }
//            showDataArea();
//        } else {
//            showNoDataArea();
...
//    }
    ...
    private void showNoDataArea() {
        browserActivityBinding.noDataErrorTv.setText(R.string.no_pdf_found);

        browserActivityBinding.dataListArea.setVisibility(View.GONE);
        browserActivityBinding.noDataErrorArea.setVisibility(View.VISIBLE);
        browserActivityBinding.noPermissionArea.setVisibility(View.GONE);
        browserActivityBinding.loadingArea.setVisibility(View.GONE);
    }

    private void showPermissionIssueArea() {
        browserActivityBinding.noPermissionArea.setOnClickListener(v -> {
            startRequestPermission();
        });
        browserActivityBinding.dataListArea.setVisibility(View.GONE);
        browserActivityBinding.noDataErrorArea.setVisibility(View.GONE);
        browserActivityBinding.noPermissionArea.setVisibility(View.VISIBLE);
        browserActivityBinding.loadingArea.setVisibility(View.GONE);
    }

    private void showDataArea() {
        browserActivityBinding.dataListArea.setVisibility(View.VISIBLE);
        browserActivityBinding.noDataErrorArea.setVisibility(View.GONE);
        browserActivityBinding.noPermissionArea.setVisibility(View.GONE);
        browserActivityBinding.loadingArea.setVisibility(View.GONE);
    }
    ...
    private void showLoadingArea() {
        browserActivityBinding.dataListArea.setVisibility(View.GONE);
        browserActivityBinding.noDataErrorArea.setVisibility(View.GONE);
        browserActivityBinding.loadingArea.setVisibility(View.VISIBLE);
        browserActivityBinding.noPermissionArea.setVisibility(View.GONE);
    }
        ...
        if (PdfUtils.isPDFEncrypted(fileData.getFilePath())) {
            ...
            pdfLockedOptionDialog = new PdfLockedOptionDialog(isBookmarked, fileData.getDisplayName(), fileData.getTimeAdded(), position, new PdfLockedOptionDialog.LockedFileOptionListener() {
                ...
                public void openFile(int position) {
                    FirebaseUtils.sendEventFunctionUsed(this, "Open file", "From browser");
