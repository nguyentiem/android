...
import com.pdfreader.scanner.pdfviewer.utils.adapter.DataOptionAdapter;
...
public class DataOptionDialog extends Dialog implements OnDataOptionClickListener {
    ...
    private boolean mIsShowColor = false;

    public DataOptionDialog(@NonNull Context context, String title, String[] optionList, String selectedOption, DataOptionSubmit listener, boolean isShowColor) {
        super(context);
        mListener = listener;
        mContext = context;
    ...
    private void setForRecyclerView() {
        ...
        mAdapter = new DataOptionAdapter(this, mOptionList, currentIndex, mIsShowColor);
