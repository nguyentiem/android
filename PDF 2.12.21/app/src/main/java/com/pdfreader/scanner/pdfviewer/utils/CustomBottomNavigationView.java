...
public class CustomBottomNavigationView extends BottomNavigationView {
    ...
    private final int CURVE_CIRCLE_RADIUS = getHeight()/2;// /2
    ...
    private void init() {
        ...
        mPaint.setShadowLayer(8, 0, 0, ColorUtils.getColorFromResource(getContext(), R.color.navigation_bar_shadow_color));// do bong
    }
