package com.pdfreader.scanner.pdfviewer.ui.pdftoimage.done;

import static com.pdfreader.scanner.pdfviewer.utils.pdf.ImageToPdfConstants.AUTHORITY_APP;
...
import com.pdfreader.scanner.pdfviewer.data.model.PDFToImageOptions;
import com.pdfreader.scanner.pdfviewer.databinding.ActivityPdfToImageDoneBinding;
...
import com.pdfreader.scanner.pdfviewer.ui.imageview.ImageViewActivity;
import com.pdfreader.scanner.pdfviewer.ui.pdftoimage.PdfToImageAdapter;
import com.pdfreader.scanner.pdfviewer.ui.pdftoimage.PdfToImageNavigator;
import com.pdfreader.scanner.pdfviewer.ui.pdftoimage.PdfToImageViewModel;
...
import com.pdfreader.scanner.pdfviewer.utils.pdftoimage.PdfToImageListener;
import com.pdfreader.scanner.pdfviewer.utils.pdftoimage.PdfToImageManager;
...
public class PdfToImageDoneActivity extends BaseBindingActivity<ActivityPdfToImageDoneBinding, PdfToImageViewModel> implements PdfToImageNavigator, OnItemImageActionListener, PdfToImageListener {
    ...
    public void onDelete(int position) {
        if (position >= 0 && position < mOutputList.size()) {
            ...
            mOutputAdapter.removeData(position);
    ...
    public void onCreateFinish(int numberSuccess, int numberError, int type) {
        runOnUiThread(() -> {
            ...
            if (numberSuccess == 0) {
                ...
                mActivityPdfToImageDoneBinding.createLayout.btnShareAll.setOnClickListener(view -> {
                ...
                mActivityPdfToImageDoneBinding.createLayout.btnShareAll.setOnClickListener(view -> {
                    ...
                    for(ImageExtractData imageExtractData : mOutputList) {
                        File file = new File(imageExtractData.getFilePath());
                        Uri uri = FileProvider.getUriForFile(PdfToImageDoneActivity.this, AUTHORITY_APP, file);
                        files.add(uri);
                    }
