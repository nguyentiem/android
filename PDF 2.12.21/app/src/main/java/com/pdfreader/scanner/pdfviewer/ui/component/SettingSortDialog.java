...
//    private static final String TAG = "SettingSortDialog";
    ...
    public SettingSortDialog(@NonNull Context context, SettingSortSubmit listener, int mCurrent) {
        super(context);
        mListener = listener;
        mContext = context;
       this.mCurrentSort = mCurrent;
        ...
        mActiveColor = ColorUtils.getThemeColor(getContext());
...
//                    Log.d(TAG, "SettingSortDialog: sort: "+newSort);
                    }
