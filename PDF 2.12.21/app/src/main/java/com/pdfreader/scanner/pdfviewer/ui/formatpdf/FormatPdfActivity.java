...
import com.pdfreader.scanner.pdfviewer.databinding.ActivityCreatePdfDoneBinding;
...
public class FormatPdfActivity extends BaseBindingActivity<ActivityCreatePdfDoneBinding, FormatPdfViewModel> implements FormatPdfNavigator {
    ...
    private void setForLayoutView() {
        if (mCreatingStatus == STATE_NOT_STARTED) {
            ...
            mActivityCreatePdfDoneBinding.createLayout.btnOpen.setVisibility(View.GONE);
            mActivityCreatePdfDoneBinding.createLayout.btnShare.setVisibility(View.GONE);
            ...
            if (mCreatingStatus == STATE_DONE) {
                ...
                if (mOutputPath != null) {
                    ...
                    mActivityCreatePdfDoneBinding.createLayout.convertSuccessLocation.setText(getString(R.string.location_file) + " " + FileUtils.getFileDirectoryPath(mOutputPath));
                } else {
                    mActivityCreatePdfDoneBinding.createLayout.convertSuccessEditName.setText("No name");
                    mActivityCreatePdfDoneBinding.createLayout.convertSuccessLocation.setText(getString(R.string.location_file) + " " + "NA");
                }
